 ...
 */
const TOKEN_KEY = "scfire_api_token";
...
export function apiChangePassword(baseUrl: string, current: string, next: string) {
  return post(baseUrl, "/profile/password", { current, next }, "PATCH");
}
