...
const SESSION_KEY = "scfire_mock_session";
const SUPER_ADMIN = "galdinomus@gmail.com";
...
const accounts: Record<string, Account> = {
  "u_admin": {
    ...
    profile: {
      id: "u_admin",
      email: SUPER_ADMIN,
      full_name: "Administrador SC Fire",
      status: "approved",
...
function defaultSdrConfig(userId: string): SdrConfig {
  return {
    ...
    agent_name: "Sofia",
    company_context:
      "A SC Fire (EZS Consultoria e Treinamentos) presta serviços de segurança contra incêndio: laudos técnicos (SAVE, PPCI, Habite-se), vistorias e treinamentos de brigada de incêndio. O agente atende leads no WhatsApp, tira dúvidas e conduz até o agendamento da visita técnica.",
    products: "Laudo técnico SAVE; Projeto e laudo PPCI; Vistoria e adequação para Habite-se; Treinamento de brigada de incêndio.",
...
const crmCards: CrmCard[] = [
  { id: "c1", user_id: "u_admin", lead_name: "Carla Dias", phone: "+5511988887777", stage: "conversas", last_message: "Oi, queria saber sobre o laudo SAVE do meu prédio", updated_at: "2026-07-13T09:12:00.000Z" },
  { id: "c2", user_id: "u_admin", lead_name: "João Prado", phone: "+5511977776666", stage: "conversas", last_message: "Vocês fazem treinamento de brigada?", updated_at: "2026-07-13T08:40:00.000Z" },
  { id: "c3", user_id: "u_admin", lead_name: "Marina Reis", phone: "+5511966665555", stage: "negociando", last_message: "Consigo desconto pagando à vista?", updated_at: "2026-07-12T18:05:00.000Z" },
  { id: "c4", user_id: "u_admin", lead_name: "Pedro Alves", phone: "+5511955554444", stage: "negociando", last_message: "Vou fechar o PPCI até sexta", updated_at: "2026-07-12T16:22:00.000Z" },
  ...
  { id: "c6", user_id: "u_admin", lead_name: "Rafael Melo", phone: "+5511933332222", stage: "perda", last_message: "Vou deixar para o próximo trimestre", updated_at: "2026-07-10T11:30:00.000Z" },
];
...
const chats: Chat[] = [
  {
    ...
    phone: "+5511988887777",
    last_message: "Oi, queria saber sobre o laudo SAVE do meu prédio",
    unread: 2,
    messages: [
      { id: "m1", from: "lead", text: "Oi, queria saber sobre o laudo SAVE do meu prédio", at: "2026-07-13T09:10:00.000Z" },
      { id: "m2", from: "agent", text: "Oi, Carla! Que bom falar com você 😊 O laudo SAVE avalia a segurança contra incêndio do imóvel. Ele é comercial, residencial ou industrial?", at: "2026-07-13T09:11:00.000Z" },
      { id: "m3", from: "lead", text: "É um prédio comercial", at: "2026-07-13T09:12:00.000Z" },
    ],
  },
  {
    id: "ch2",
    ...
    phone: "+5511966665555",
    last_message: "Consigo desconto pagando à vista?",
    unread: 0,
    messages: [
      { id: "m4", from: "lead", text: "Consigo desconto pagando à vista?", at: "2026-07-12T18:05:00.000Z" },
