...
/** Upload de fotos dos sistemas de segurança contra incêndio instalados, para o Supabase Storage. */
            ...
            <div key={img.url} className="rounded-lg border border-white/[0.08] overflow-hidden bg-black/20">
              ...
              <div className="p-1.5 flex items-center gap-1">
                <input
                  ...
                  placeholder="Legenda (ex: extintor, iluminação...)"
